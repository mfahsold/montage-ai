...
- `/shorts` — Shorts Studio for vertical video (9:16)
- `/transcript` — Text-based video editing (Descript-style)
...
| [Backlog](docs/STRATEGIC_BACKLOG.md) | Epics & user stories |
...
- [View the backlog](docs/STRATEGIC_BACKLOG.md)
