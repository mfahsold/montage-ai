...
- Short or synthetic WAVs (very short or extremely flat energy profiles) may trigger an edge-case in older versions and abort analysis. For reliable smoke runs, use a WAV >= 3–4s or the synthetic fixtures generated by `make test-fixtures`.
