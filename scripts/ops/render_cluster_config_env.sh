...
WORKER_QUEUE_LIST_NAME=${WORKER_QUEUE_LIST_NAME}
...
CLUSTER_PARALLELISM=${CLUSTER_PARALLELISM}
CLUSTER_RENDER_TIER=${CLUSTER_RENDER_TIER}
SCENE_DETECT_TIER=${SCENE_DETECT_TIER}
