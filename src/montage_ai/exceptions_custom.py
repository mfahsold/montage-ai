...
DEPRECATED: This module provides enhanced exceptions with user_message and suggestions,
but is not widely used in the codebase.

Recommendation: Use exceptions.py instead and add context via logging.

Planned for: Possible integration into main exceptions.py in v2.0
...
warnings.warn(
    "exceptions_custom.py is deprecated. Use exceptions.py instead. "
    "Enhanced error messages should be handled via logging, not custom exception classes.",
    DeprecationWarning,
    stacklevel=2,
)
