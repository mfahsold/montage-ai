...
from .ffmpeg_config import COLOR_PRESETS, LUT_FILES, AUDIO_FILTERS, STANDARD_CODEC
import shutil
...
class FFmpegTool:
    ...
    execute: Callable[[Dict[str, Any]], Dict[str, Any]] = field(
...
class FFmpegToolkit:
    ...
    def _register_tools(self):
        ...
        self.tools["extract_frames"] = FFmpegTool(
            ...
            parameters=[
                ...
                ToolParameter(
                    "output_dir", "string", "Directory to save extracted frames"
                ),
                ToolParameter(
                    "format",
                    "string",
        ...
        self.tools["apply_transition"] = FFmpegTool(
            ...
            parameters=[
                ...
                ToolParameter(
                    "transition",
                    "string",
                    "Transition type: crossfade, wipe, slide, fade",
                ),
        ...
        self.tools["color_grade"] = FFmpegTool(
            ...
            parameters=[
                ...
                ToolParameter(
                    "preset",
                    "string",
                    "Preset name: cinematic, vintage, cold, warm, noir, vivid",
                ),
                ToolParameter(
                    "intensity", "number", "Effect intensity from 0.0 to 1.0"
                ),
                ToolParameter("output", "string", "Path to output video file"),
                ToolParameter(
                    "lut_path",
                    "string",
                    "Optional custom LUT file path",
                    required=False,
                ),
            ],
        ...
        self.tools["resize"] = FFmpegTool(
            ...
            parameters=[
                ToolParameter("input", "string", "Path to input video file"),
                ToolParameter(
                    "width", "number", "Target width in pixels (-1 for auto)"
                ),
                ToolParameter(
                    "height", "number", "Target height in pixels (-1 for auto)"
                ),
                ToolParameter("output", "string", "Path to output video file"),
                ToolParameter(
                    "algorithm",
        ...
        self.tools["concatenate"] = FFmpegTool(
            ...
            parameters=[
                ToolParameter(
                    "clips", "array", "List of video file paths to concatenate"
                ),
                ToolParameter("output", "string", "Path to output video file"),
                ToolParameter(
                    "reencode",
        ...
        self.tools["get_video_info"] = FFmpegTool(
            ...
            parameters=[ToolParameter("input", "string", "Path to video file")],
        ...
        self.tools["speed_change"] = FFmpegTool(
            ...
            parameters=[
                ...
                ToolParameter(
                    ...
                    "boolean",
                    "Keep audio pitch when changing speed",
                    required=False,
                    default=True,
                ),
            ],
    ...
    def _extract_frames(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"success": True, "output": extracted, "count": len(extracted)}
    ...
    def _create_segment(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        codec_args = (
            ["-c", "copy"] if codec == "copy" else ["-c:v", codec, "-c:a", "aac"]
        )
        ...
        return {"success": True, "output": output_path, "duration": duration}
    ...
    def _color_grade(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Priority 2: Check if preset maps to a LUT file
            ...
            if os.path.exists(lut_file):
                ...
                return {
                    "success": False,
                    "error": f"LUT file not found: {lut_file}. Mount LUTs to {lut_dir}",
                }
        ...
        result = self._run_ffmpeg(
            ["-i", input_path, "-vf", filter_str, "-c:a", "copy", output]
        )
    ...
    def _mix_audio(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"success": True, "output": output, "mode": mode}
    ...
    def _resize(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = self._run_ffmpeg(
            ["-i", input_path, "-vf", scale_filter, "-c:a", "copy", output]
        )

        if result.returncode != 0:
            return {"success": False, "error": result.stderr}

        return {"success": True, "output": output, "width": width, "height": height}
    ...
    def _concatenate(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"success": True, "output": output, "clips_count": len(clips)}
    ...
    def _get_video_info(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        info = {
            ...
            if metadata.path.endswith((".mp4", ".mov"))
    ...
    def _thumbnail_grid(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = self._run_ffmpeg(
            [
                ...
                input_path,
                "-vf",
                f"fps=1/{interval},scale=320:-1,tile={columns}x{rows}",
                "-frames:v",
                "1",
                "-q:v",
                "2",
    ...
    def _speed_change(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"success": True, "output": output, "speed": speed}
