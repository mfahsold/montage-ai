...
DEFAULT_OPTIONS = {
    ...
    "stabilize_ai": _settings.stabilization.ai_enabled,
    "stabilize_mode": _settings.stabilization.mode,
    "aggressive_smoothing": _settings.stabilization.aggressive_smoothing,
    "fast_stabilization": _settings.stabilization.fast_stabilization,
    "skip_color_correction": _settings.stabilization.skip_color_correction,
...
UI_TOGGLE_CONFIG = [
    ...
    {
        "id": "stabilize_ai",
        "label": "AI Stabilization",
        "desc": "Use ProStabilizationEngine for enhanced smoothing.",
        "category": "advanced",
        "badges": [{"type": "quality", "text": "Pro Stabilize"}],
    },
    {
        "id": "aggressive_smoothing",
        "label": "Aggressive Smoothing",
        "desc": "Enable stronger motion smoothing (minterpolate).",
        "category": "advanced",
        "badges": [{"type": "quality", "text": "Cinema Smooth"}, {"type": "cost", "text": "Slower"}],
    },
    {
        "id": "fast_stabilization",
        "label": "Fast Stabilization",
        "desc": "Skip motion smoothing for faster previews.",
        "category": "advanced",
        "badges": [{"type": "info", "text": "Preview"}],
    },
    {
        "id": "skip_color_correction",
        "label": "Skip Stabilization Color",
        "desc": "Disable color correction inside stabilization pass.",
        "category": "advanced",
        "badges": [{"type": "info", "text": "Original Color"}],
    },
    {
        "id": "generate_proxies",
